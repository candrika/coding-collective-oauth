...
CREATE DATABASE IF NOT EXISTS `information_schema` /*!40100 DEFAULT CHARACTER SET utf8mb3 */;
...
) ENGINE=Aria DEFAULT CHARSET=utf8mb3 PAGE_CHECKSUM=0;
...
-- Dumping database structure for laravel_oauth_api
CREATE DATABASE IF NOT EXISTS `laravel_oauth_api` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `laravel_oauth_api`;

-- Dumping structure for table laravel_oauth_api.candidates
CREATE TABLE IF NOT EXISTS `candidates` (
  ...
  `top_skills` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`top_skills`)),
...
-- Dumping structure for table laravel_oauth_api.failed_jobs
...
-- Dumping structure for table laravel_oauth_api.migrations
...
-- Dumping structure for table laravel_oauth_api.oauth_access_tokens
...
-- Dumping structure for table laravel_oauth_api.oauth_auth_codes
...
-- Dumping structure for table laravel_oauth_api.oauth_clients
...
-- Dumping structure for table laravel_oauth_api.oauth_personal_access_clients
...
-- Dumping structure for table laravel_oauth_api.oauth_refresh_tokens
...
-- Dumping structure for table laravel_oauth_api.password_resets
...
-- Dumping structure for table laravel_oauth_api.personal_access_tokens
...
-- Dumping structure for table laravel_oauth_api.roles
...
-- Dumping structure for table laravel_oauth_api.users
...
CREATE DATABASE IF NOT EXISTS `performance_schema` /*!40100 DEFAULT CHARACTER SET utf8mb3 */;
...
CREATE TABLE IF NOT EXISTS `session_account_connect_attrs` (
  ...
  `ATTR_NAME` varchar(32) COLLATE utf8mb3_bin NOT NULL COMMENT 'Attribute name.',
  `ATTR_VALUE` varchar(1024) COLLATE utf8mb3_bin DEFAULT NULL COMMENT 'Attribute value.',
...
-- Dumping structure for table simrs.action_category
CREATE TABLE IF NOT EXISTS `action_category` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `action_category_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `action_category` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dumping structure for table simrs.bangsal_patient
CREATE TABLE IF NOT EXISTS `bangsal_patient` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dumping structure for table simrs.carier
CREATE TABLE IF NOT EXISTS `carier` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `carier_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `carier_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dumping structure for table simrs.departement
...
-- Dumping structure for table simrs.diagnosis
CREATE TABLE IF NOT EXISTS `diagnosis` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `diagnosis_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `disease_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `indicator_disease` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `describe` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `common_features` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dumping structure for table simrs.doctor
CREATE TABLE IF NOT EXISTS `doctor` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `doctor_code` int(11) NOT NULL DEFAULT 0,
  `doctor_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ponsel_no` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `specialist` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `license_no` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `graduate` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dumping structure for table simrs.doctor_pratice
CREATE TABLE IF NOT EXISTS `doctor_pratice` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `scheldule` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `doctor_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  CONSTRAINT `fk_doctor_name` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Data exporting was unselected.

-- Dumping structure for table simrs.employees
...
-- Dumping structure for table simrs.failed_jobs
CREATE TABLE IF NOT EXISTS `failed_jobs` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `uuid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `connection` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping structure for table simrs.hospital_profile
...
-- Dumping structure for table simrs.inpatient_room
...
-- Dumping structure for table simrs.inventory_category
...
-- Dumping structure for table simrs.inventory_unit
...
-- Dumping structure for table simrs.laboratory_examination
CREATE TABLE IF NOT EXISTS `laboratory_examination` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dumping structure for table simrs.laboratory_subexamination
CREATE TABLE IF NOT EXISTS `laboratory_subexamination` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dumping structure for table simrs.medicinekit_order
CREATE TABLE IF NOT EXISTS `medicinekit_order` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dumping structure for table simrs.medicinekit_sale
CREATE TABLE IF NOT EXISTS `medicinekit_sale` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dumping structure for table simrs.medicine_kit
CREATE TABLE IF NOT EXISTS `medicine_kit` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `inventory_category_id` bigint(20) unsigned NOT NULL DEFAULT 0,
  `unit_id` bigint(20) unsigned NOT NULL DEFAULT 0,
  `price` double(12,2) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_invetory_category` (`inventory_category_id`),
  KEY `fk_inventory_unit` (`unit_id`),
  CONSTRAINT `fk_inventory_unit` FOREIGN KEY (`unit_id`) REFERENCES `inventory_unit` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_invetory_category` FOREIGN KEY (`inventory_category_id`) REFERENCES `inventory_category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Data exporting was unselected.

-- Dumping structure for table simrs.menu
CREATE TABLE IF NOT EXISTS `menu` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `url` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `icon` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_main_menu` smallint(6) NOT NULL,
  `is_aktif` smallint(6) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dumping structure for table simrs.migrations
CREATE TABLE IF NOT EXISTS `migrations` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `migration` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `batch` int(11) NOT NULL,
...
-- Dumping structure for table simrs.model_field
...
-- Dumping structure for table simrs.overtimes
CREATE TABLE IF NOT EXISTS `overtimes` (
  ...
  CONSTRAINT `overtimes_employee_id_foreign` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Data exporting was unselected.

-- Dumping structure for table simrs.password_resets
CREATE TABLE IF NOT EXISTS `password_resets` (
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `token` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
-- Dumping structure for table simrs.patient
CREATE TABLE IF NOT EXISTS `patient` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `medical_record_no` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `marriage_status` smallint(6) NOT NULL DEFAULT 1 COMMENT '1 merrid 2 singled',
  `birth_date` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone_no` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `job_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `merriage_status_id` int(11) NOT NULL,
  `sex_type` smallint(6) NOT NULL DEFAULT 1,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dumping structure for table simrs.personal_access_tokens
CREATE TABLE IF NOT EXISTS `personal_access_tokens` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `tokenable_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tokenable_id` bigint(20) unsigned NOT NULL,
...
-- Dumping structure for table simrs.position
...
-- Dumping structure for table simrs.references
...
-- Dumping structure for table simrs.role
...
-- Dumping structure for table simrs.settings
CREATE TABLE IF NOT EXISTS `settings` (
  `key` enum('overtime_method') COLLATE utf8mb4_unicode_ci NOT NULL,
  `value` smallint(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Data exporting was unselected.

-- Dumping structure for table simrs.specialist
...
-- Dumping structure for table simrs.supplier
...
-- Dumping structure for table simrs.users
CREATE TABLE IF NOT EXISTS `users` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE DATABASE IF NOT EXISTS `sys` /*!40100 DEFAULT CHARACTER SET utf8mb3 */;
USE `sys`;

-- Dumping structure for table sys.adonis_schema
...
-- Dumping structure for table sys.posts
...
DELIMITER //
CREATE FUNCTION `quote_identifier`(in_identifier TEXT) RETURNS text CHARSET utf8mb3
    NO SQL
    DETERMINISTIC
    SQL SECURITY INVOKER
...
-- Dumping structure for table sys.tokens
...
-- Dumping structure for table sys.users
CREATE TABLE IF NOT EXISTS `users` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
